...
const useStyles = makeStyles((theme: Theme) =>
    createStyles({
        ...
        spy: { color: 'white', fontSize: '40px', display: 'inline-block', paddingLeft: '10px' },
        preGuess: { color: '#cccccc', fontWeight: 'normal', display: 'inline-block', paddingTop: '10px' },
        guess: { color: 'white', fontWeight: 'normal', display: 'inline-block', paddingLeft: '5px' },
        preLocation: { color: '#cccccc', fontWeight: 'normal', display: 'inline-block' },
        location: { color: 'white', fontWeight: 'normal', display: 'inline-block', paddingLeft: '5px', paddingTop: '10px' },
        scoreGroup: { width: '100%', display: 'flex', height: '350px', flexFlow: 'column', overflowY: 'auto', alignItems: 'center' },
        scoreElement: { display: 'table', marginTop: '7px' },
        scoreElementNickname: { display: 'table-cell', color: '#dddddd', fontSize: '20px' },
        scoreElementPoints: { display: 'table-cell', color: '#ffa726', fontSize: '20px', paddingLeft: '10px' }
    })
)
            ...
            <div style={{marginBottom: '20px', marginTop: '40px'}}>
                ...
                <br/>
                {
                    endGame.guessedLocation ? <div>
                        ...
                        <h2 className={classes.guess}>{endGame.guessedLocation}</h2><br/>
                    </div> : null
                }
